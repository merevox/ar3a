                    ...
                    <ul class="navigation--list ">
                        ...
                        {block name="frontend_index_left_categories_close_menu"}
                            <li class="navigation--entry entry--close-off-canvas">
                                <a href="#close-categories-menu" title="{s namespace='frontend/index/menu_left' name="RevoxIndexActionCloseMenu"}Schliessen{/s}" class="navigation--link">
                                    {s namespace='frontend/index/menu_left' name="RevoxIndexActionCloseMenu"}{/s} <i class="icon--cross"></i>
                                </a>
                            </li>
                        {/block}
                    </ul>
