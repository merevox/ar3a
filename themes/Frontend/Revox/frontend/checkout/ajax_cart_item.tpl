...
<div class="cart--item{if $basketItem.modus == 1} is--premium-article{/if}">
    ...
    {block name='frontend_checkout_ajax_cart_articlename'}
		...
		{if ($basketItem.ordernumber|strstr:'141010100') && {$basketItem.additional_details.no_stock == 1}}
            <div class="noinstock">
                <h2>{s name="RevoxAjaxCartSign"}Hinweis{/s}</h2>
                {s name="RevoxAjaxCartInsertS100black"}<p>Der Artikel ist derzeit wegen hoher Nachfrage für einige Zeit Online nicht verfügbar.</p>
                <p>Bitte wählen Sie zwischen folgenden Optionen:</p>
                <a href="lautsprecher/studioart/39/studioart-s100-audiobar?number=141010200">
                    <li>
                        <img id="artikelbild" src="https://revox.com/media/image/65/a3/9f/Revox-STUDIOART-S100-Audiobar-Soundbar_weiss_Freisteller_weiss_webhmJIEfztKatWB_140x140.jpg">
                        <p>STUDIOART S100 AUDIOBAR in Weiss</p>
                    </li>
                </a>
                <a href="https://revox.com/Filialfinder?opt8=1">
                    <li>
                        <img src="themes/Frontend/Revox/frontend/_public/src/img/icons/stift.png">
                        <p>Revox-Händler mit Bestand</p>
                    </li>
                </a>
                <a href="https://revox.com/shopware.php?sViewport=forms&sFid=16">
                    <li>
                        <img src="themes/Frontend/Revox/frontend/_public/src/img/icons/bearbeiten.png">
                        <p>Anfrage-Formular zur Lieferzeit</p>
                    </li>
                </a>{/s}
            </div>
        {/if}
